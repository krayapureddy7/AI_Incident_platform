...
echo ""
echo "Stage 1/4: Unit, agent, contract, safety, and API tests"
"$PYTHON" -m pytest tests/ -q

echo ""
echo "Stage 2/4: Evaluation gate (trajectory + safety invariants)"
"$PYTHON" -m mini_platform.evals.eval_runner

echo ""
echo "Stage 3/4: End-to-end demo sanity check"
"$PYTHON" -m mini_platform.demo > /dev/null

echo ""
echo "Stage 4/4: CLI smoke checks"
